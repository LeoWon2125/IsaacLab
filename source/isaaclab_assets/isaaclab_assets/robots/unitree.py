...
G1_WITH_HAND_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/intern3/Desktop/IsaacLab/source/isaaclab_assets/isaaclab_assets/robots/g1_29dof_with_hand/g1_29dof_with_hand.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "left_hand_index_1_joint": -0.52,
            "right_hand_index_1_joint": 0.52,
        },
        joint_vel={".*": 0.0},
    ),
    soft_joint_pos_limit_factor=0.9,
...
"""Configuration for the Unitree G1 Humanoid robot with hand."""
